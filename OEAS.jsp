...
%>
		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<div class="card">
					...
					<form action="chercherO.do" method="post">
					<label>MotCle:</label>
				...
				<p></p>
                          ...
                          <small>
                             ${objet.value}% Complete
 										...
 										<th>${objet.date_ajout}</th> 
											
		<th>${objet.type_idType}</th>
    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <form id="myForm${vs.index}" action="editobjet.do" method="post">
...
<!--                 Si le type est changer les taches doient changer. -->
                
<!--                   <div class="form-group"> -->
<!--                     <label for="exampleInputEmail1">Type</label> -->
<%--                     <input type="text" class="form-control" name="type" value=${objet.type_idType } > --%>
<!--                 </div> -->
                ...
                <div class="form-group">
								...
								<div class="select-wrap one-third">
									...
									<select name="type" value=${objet.type_idType } class="form-control"
...
<!--                 </div> -->
                ...
                <div class="form-group">
								...
								<div class="select-wrap one-third">
									...
									<select name="idclient" value=${objet.cin } class="form-control"
										placeholder="cin" required>
										<c:forEach items="${model.getClients()}" var="t">

											<option>${t.getCin()}</option>
