...
<!-- 					<li><a href="/Bachelor/admin/AdminLTE-3.0.1/index0.jsp">Mon interface</a></li> -->
					<li><a href="saisirC.do">Mon interface</a></li>
					
					<li><a href="deco.do">Deconnexion</a></li>
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					<h1>Tracer</h1>
					<p>Il s'agit d'un site cree par ER-RYFY SAFOUAN, un etudiant en <a href="http://www.bachmek.umi.ac.ma/">Bachlor</a>  sous l'encadrement et le suivi <br />
