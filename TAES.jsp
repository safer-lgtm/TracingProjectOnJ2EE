		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a
					href="HomeA.jsp" class="nav-link">Home</a></li>
			...
			<ul class="navbar-nav ml-auto">
				<li class="nav-item d-none d-sm-inline-block"><a href="deco.do"
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item has-treeview "><a href="#"
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a href="saisirC.do" class="nav-link ">
										<!-- <a href="/Tracer/saisirC.do" class="nav-link"> --> <i
										class="far fa-circle nav-icon"></i>
										<p>add client</p>
								</a></li>
								<li class="nav-item"><a href="affclient.do"
						...
						<li class="nav-item has-treeview "><a href="#"
							class="nav-link "> <i class="nav-icon fas fa-chart-pie"></i>
								<p>
									Gestion Employe <i class="right fas fa-angle-left"></i>
								</p>
						</a>
							<ul class="nav nav-treeview">
								<li class="nav-item"><a href="saisirE.do" class="nav-link">
										<!-- <a href="/Tracer/saisirE.do" class="nav-link"> --> <i
										class="far fa-circle nav-icon"></i>
										<p>add emp</p>
								</a></li>
								<li class="nav-item"><a href="affemp.do" class="nav-link ">
						...
						<li class="nav-item has-treeview  "><a href="#"
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a href="saisirO.do" class="nav-link">
										<!-- <a href="/Tracer/saisirO.do" class="nav-link"> --> <i
										class="far fa-circle nav-icon"></i>
										<p>add objet</p>
								</a></li>
								<li class="nav-item"><a href="affobjet.do"
									class="nav-link "> <i class="far fa-circle nav-icon"></i>
										<p>aff objet</p>
								</a></li>
						...
						<li class="nav-item has-treeview"><a href="#"
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item"><a href="saisirtt.do" class="nav-link">
										<i class="far fa-circle nav-icon"></i>
										<p>add type</p>
								</a></li>
						...
						<li class="nav-item has-treeview menu-open"><a href="#"
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a href="saisirT.do" class="nav-link">
										<!-- <a href="/Tracer/saisirT.do" class="nav-link"> --> <i
										class="far fa-circle nav-icon"></i>
										<p>add tache</p>
								</a></li>
								<li class="nav-item"><a href="afftache.do"
						...
						<table class="table table-bordered">
							...
							<tbody>
								<c:forEach items="${model.taches}" var="tache" varStatus="vs">
									...
									<tr>
										...
										<td class="project_progress">
											<div class="progress progress-sm">
												<div class="progress-bar bg-green" role="progressbar"
													aria-volumenow="${tache.value}" aria-volumemin="0"
													aria-volumemax="100" style="width: ${tache.value}%">
												</div>
											</div> <small> ${tache.value}% Complete </small>
										</td>
										...
										<th>${tache.type_idType}</th>

										<th>${tache.employe_idEmploye}</th>
										...
										<th style="width: 30px"><a
											...
											href="suptache.do?id=${tache.idTaches}"> <i
									...
									<div class="modal fade modalEditClass" id="myModal${vs.index}"
												...
												<div class="modal-body">
													<div class="card card-primary">
														...
														<div class="card-body">
															...
															<form id="myForm${vs.index}" action="edtache.do"
																method="post">
																<div class="form-group">
																	<label for="exampleInputEmail1">id Tache</label> <input
																		type="text" class="form-control" name="id"
																		value=${tache.idTaches } readonly>
																</div>
																<div class="form-group">
																	<label for="exampleInputEmail1">Nom de tache</label> <input
																		type="text" class="form-control" name="nom"
																		value=${tache.nom }>
																</div>

																<div class="form-group">
																	<label for="exampleInputEmail1">Progression</label> <input
																...
																<div class="form-group">
																	...
																	<div class="select-wrap one-third">
																		<label for="exampleInputEmail1">etat</label> <select
																			name="etat" class="form-control" placeholder="etat"
																			required>
																...
																<%--                     <input type="text" class="form-control" name="ido" value=${tache.num_obj }> --%>
																<!--                 </div> -->
																...
																<div class="form-group">
																	...
																	<div class="select-wrap one-third">
																		...
																		<select name="ido" value="" class="form-control"
																			placeholder="objet" required>
																			<c:forEach items="${model.getObjets()}" var="v">

																				<option>${v.getNomObj()}</option>
																...
																<!-- 																<div class="form-group"> -->
																<!-- 																	<label for="exampleInputEmail1">Identifiant du -->
																<!-- 																		type</label> <input type="text" class="form-control" -->
																<%-- 																		name="idt" value=${tache.type_idType }> --%>
																<!-- 																</div> -->
							...
							<div class="form-group">
								...
								<div class="select-wrap one-third">
									...
									<select name="idt" value="" class="form-control"
										placeholder="type" required>
										<c:forEach items="${model.getTypes()}" var="t">

											<option>${t.getNom_type()}</option>
																...
																<!-- 																<div class="form-group"> -->
																<!-- 																	<label for="exampleInputEmail1">Responsable de -->
																<!-- 																		la tache</label> <input type="text" class="form-control" -->
																<%-- 																		name="ide" value=${tache.employe_idEmploye }> --%>
																<!-- 																</div> -->
																<div class="form-group">
																	<label for="exampleInputEmail1">Responsable
																		tache</label>
																	<div class="select-wrap one-third">

																		<select name="ide" value="" class="form-control"
																			placeholder="employe" required>
																			<c:forEach items="${model.getEmps()}" var="g">

																				<option>${g.getNom_emp()}</option>
