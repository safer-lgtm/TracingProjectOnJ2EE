        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="saisirC.do" class="nav-link active">
    ...
    <section class="content">
      <!-- general form elements -->
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form  action ="confirmer.do"  method="post">
                <div class="card-body">
                 
                  <div class="form-group">
                    <label for="exampleInputEmail1">Email Client</label>
                    <input type="text" class="form-control" value = "${emailClient}" name= "recipient"  >
                  </div>
...
<!--                   </div>  -->
                   ...
                   <textarea  class="form-control"   name= "content" rows="3"> Bonjour Mr(Mlle) ${nomCl},
                                      Votre CIN est : ${cinCl}
