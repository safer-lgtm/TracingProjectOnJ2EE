...
%>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/Tracer/templated-industrious/HomeA.jsp" class="nav-link">Home</a>
      </li>
    ...
    <ul class="navbar-nav ml-auto">
   		...
   		<a href="/Tracer/deco.do" class="nav-link" >Deconnexion</a>
      ...
      <li class="nav-item">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index3.html" class="brand-link"> <img
				...
				class="brand-text font-weight-light">Admin Nizar</span>
			</a>
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					...
					<div class="info">
						<a href="index.html" class="d-block">Nizar</a>
					</div>
				</div>
              ...
              <li class="nav-item">
                <a href="/Tracer/admin/AdminLTE-3.0.1/index0.jsp" class="nav-link ">
               ...
               <li class="nav-item">
                 ...
                 <a href="/Tracer/affclient.do" class="nav-link  ">
                <i class="far fa-circle nav-icon" ></i>
                <p>afiicher client</p>
               </a>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/Tracer/admin/AdminLTE-3.0.1/AE.jsp" class="nav-link">
              ...
              <li class="nav-item">
                <a href="/Tracer/affemp.do" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>afiicher emp</p>
                </a>
              </li>
						...
						<li class="nav-item has-treeview  menu-open"><a href="#"
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a href="/Tracer/admin/AdminLTE-3.0.1/AO.jsp"	class="nav-link"> 
									<!-- <a href="/Tracer/saisirO.do" class="nav-link"> -->
									<i class="far fa-circle nav-icon"></i>
										<p>add objet</p>
								</a></li>
								<li class="nav-item"><a
									href="/Tracer/affobjet.do"
					...
					<li class="nav-item has-treeview"><a href="#"
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a
									href="/Tracer/admin/AdminLTE-3.0.1/AT.jsp" class="nav-link">
									 <!-- <a href="/Tracer/saisirT.do" class="nav-link"> -->
									 <i class="far fa-circle nav-icon"></i>
										<p>add tache</p>
								</a></li>
								<li class="nav-item"><a
									href="/Tracer/afftache.do"
			...
			<section class="content">
				...
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">List d'objet</h3>
					</div>
					<!-- /.card-header -->

					<div class="card-body">
					
					<form action="/Tracer/chercherO.do" method="post">
					<label>MotCle:</label>
							...
							<table class="table table-bordered">
								<thead>
									<tr>
										...
										<th>Progression</th>
										<th>Etat</th>
										<th>Date Creation</th>										<th>CIN du client</th>
										<th>Bureau actuel</th>
                          ...
                          <small>
                             ${objet.value}% Complete
 										...
 										<th>${objet.create_date}</th> 
											...
											<th>${objet.client_idClient}</th>
											<th>${objet.employe_idEmploye}</th>
											...
											<th style="width: 10px">
												...
												href="affTO.do?id=${objet.idObjet}"> <i
											...
											<th style="width: 30px"><a
												...
												href="supobjet.do?id=${objet.idObjet}"> <i
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Edit Objet</h3>
        </div>
        <!-- /.card-header -->
        <!-- modalform start -->
        ...
        <div class="card-body">
            ...
            <form id="myForm${vs.index}" action="/Tracer/edobjet.do" method="post">
                <div class="form-group">
                    <label for="exampleInputEmail1">id Objet</label>
                    
                    <input type="text" class="form-control" name="id" value=${objet.idObjet } readonly>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Chemin</label>
                    <input type="text" class="form-control" name="chemin" value=${objet.chemin } >
                </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nom</label>
                    <input type="text" class="form-control" name="nom" value=${objet.nomObj } >
                </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Type</label>
                    <input type="text" class="form-control" name="type" value=${objet.type } >
                </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Progression</label>
                    <input type="text" class="form-control" name="value" value=${objet.value } >
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">CIN du client</label>
                    <input type="text" class="form-control" name="idclient" value=${objet.client_idClient }>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Bureau courant</label>
                    <input type="email" class="form-control" name="bureau" value=${objet.employe_idEmploye } >
                </div>
