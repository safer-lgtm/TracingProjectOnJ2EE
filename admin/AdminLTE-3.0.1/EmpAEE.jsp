                          ...
                          <small>
                             ${tache.value}% Complete
											...
											<th style="width: 30px"><a
												...
												href="adddemande.do?ido=${tache.objet_idObjet}&ide=${tache.employe_idEmploye }"> <i
 ...
 --%>		
    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <form id="myForm${vs.index}" action="/Tracer/modvalue.do" method="post">
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ido" value=${tache.objet_idObjet } readonly>
                </div>
                 <div class="form-group">
