		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a
					href="/Tracer/templated-industrious/HomeE.jsp" class="nav-link">Home</a></li>
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item has-treeview menu-open"><a href="#"
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a
									href="/Tracer/affdemande.do"
									class="nav-link active"> <i class="far fa-circle nav-icon"></i>
										<p>Demande en cours</p>
								</a></li>
								<li class="nav-item"><a
									href="/Tracer/affetacche.do"
			...
			<section class="content">
				...
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">List des demandes</h3>
					</div>
					<!-- /.card-header -->
					...
					<div class="card-body">
							<table class="table table-bordered">
								...
								<tbody>
									<c:forEach items="${model.demandes}" var="demande" varStatus="vs">
										...
										<tr>
											...
											<th>${demande.objet_idObjet}</th>
											

											<th style="width: 30px"><a
												onclick="return confirm('voulez vous accepter de tariter cette objet?')"
												href="delpacer.do?ido=${demande.objet_idObjet}&ide=${demande.employe_idEmploye }"> <i
													class='fa fa-folder-open-o fa-2x' style='color: blue'></i></a></th>
...
<%-- 		
    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
	            ...
	            <form id="myForm${vs.index}" action="/Tracer/send.do" method="post">
