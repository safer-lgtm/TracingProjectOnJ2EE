...
%>
      ...
      <li class="nav-item">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/Tracer/affemp.do" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>afiicher emp</p>
                </a>
              </li>
		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<div class="card">
					...
					<form action="chercherE.do" method="post">
					<label>MotCle:</label>
				...
				<p></p>
							<table class="table table-bordered">
								...
								<tbody>
									<c:forEach items="${model.emps}" var="emp" varStatus="vs">
										...
										<tr>
											...
											<th style="width: 30px"><a
												...
												href="supemp.do?idEmploye=${emp.idEmploye}"> <i
    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <form id="myForm${vs.index}" action="/Tracer/edemp.do" method="post">
                <div class="form-group">
                    <label for="exampleInputEmail1">idEmploye</label>
                    
                    <input type="text" class="form-control" name="idEmploye" value=${emp.idEmploye } placeholder="Enter email" readonly>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">nom</label>
                    <input type="text" class="form-control" name="nom_emp" value=${emp.nom_emp } placeholder="Enter email">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">email</label>
                    <input type="email" class="form-control" name="e_mail_emp" value=${emp.e_mail_emp } placeholder="Enter email">
                </div>
