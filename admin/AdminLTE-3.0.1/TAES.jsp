...
%>
    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <form id="myForm${vs.index}" action="/Tracer/edtache.do" method="traitement">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nom" value=${tache.nom } >
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ido" value=${tache.objet_idObjet }>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Responsable de tache</label>
                    <input type="text" class="form-control" name="ide" value=${tache.employe_idEmploye } >
                </div>
