...
%>
			...
			<div class="sidebar">
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                 ...
                 <a href="/Tracer/affclient.do" class="nav-link active ">
                <i class="far fa-circle nav-icon" ></i>
                <p>afiicher client</p>
               </a>
                ...
                <a href="/Tracer/affemp.do" class="nav-link">
                  ...
                  <p>afiicher emp</p>
						...
						<li class="nav-item has-treeview"><a href="#"
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a href="/Tracer/admin/AdminLTE-3.0.1/AO.jsp"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>add objet</p>
								</a></li>
								<li class="nav-item"><a
									href="/Tracer/affobjet.do"	class="nav-link"> 
    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <form id="myForm${vs.index}" action="/Tracer/edclient.do" method="post">
