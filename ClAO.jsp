		...
		<nav class="navbar navbar-expand navbar-primary navbar-dark">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a
					href="HomeC.jsp" class="nav-link">Home</a></li>
				<li class="nav-item d-none d-sm-inline-block"><a href="caffo.do"
...
<br>
 ...
 <th>${objet.tracking_number}</th>
												...
												href="caffot.do?id=${objet.idObjet}"> <i
    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
	            ...
	            <form id="myForm${vs.index}" action="sendA.do" method="post">
