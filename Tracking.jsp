...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="images1/hand-holding-digital-tablet-computer-600w-745448119.jpg"/>
<!--===============================================================================================-->
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="basckground-image: url('images/hand-holding-digital-tablet-computer-600w-745448119.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					<a href="index.html" > <h2>Home</h2></a> 
				</span>
				<form class="login100-form validate-form p-b-33 p-t-5"   action ="trackinge.do"  method="POST" >

					<div class="wrap-input100 validate-input" data-validate = "Enter numero">
						<input class="input100" type="text" name="tracking" placeholder="Enter tracking number">
